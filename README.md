...
Actualmente, Funkomania Backend `v0.2.0-SNAPSHOT-2` incluye las siguientes funcionalidades:
...
1. Descargar el proyecto abriendo un terminal y clonar el repositorio usando Git en un directorio:
   ```bash
   git clone https://github.com/JuanAlberticoHF/funkomania-backend.git --branch feature/catalogo
   ```
   - Esto descargará el proyecto en tu máquina local de la rama `feature/catalogo`, que es la rama de desarrollo actual.
