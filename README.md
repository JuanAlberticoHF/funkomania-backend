...
Actualmente, Funkomania Backend `0.6.0-SNAPSHOT-1` incluye las siguientes funcionalidades:
...
1. Descargar el proyecto abriendo un terminal y clonar el repositorio usando Git en un directorio:
   ```bash
   git clone https://github.com/JuanAlberticoHF/funkomania-backend.git --branch feature/gestion-admin
   ```
   - Esto descargará el proyecto en tu máquina local de la rama `feature/gestion-admin`, que es la rama de desarrollo actual.
