...
Actualmente, Funkomania Backend `0.3.0-SNAPSHOT-1` incluye las siguientes funcionalidades:

- API REST para registrar usuarios, inicio de sesión y cierre de sesión de un usuario.
...
1. Descargar el proyecto abriendo un terminal y clonar el repositorio usando Git en un directorio:
   ```bash
   git clone https://github.com/JuanAlberticoHF/funkomania-backend.git --branch feature/datos-producto
   ```
   - Esto descargará el proyecto en tu máquina local de la rama `feature/datos-producto`, que es la rama de desarrollo actual.
