...
Actualmente, Funkomania Backend `0.7.0-SNAPSHOT-3` incluye las siguientes funcionalidades:
...
1. Descargar el proyecto abriendo un terminal y clonar el repositorio usando Git en un directorio:
   ```bash
   git clone https://github.com/JuanAlberticoHF/funkomania-backend.git --branch feature/carrito-pedidos
   ```
   - Esto descargará el proyecto en tu máquina local de la rama `feature/carrito-pedidos`, que es la rama de desarrollo actual.
