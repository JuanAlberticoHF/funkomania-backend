...
/**
 * <p>DTO que representa la información necesaria para agregar una línea de pedido por un administrador en el sistema de Funkomania.</p>
 *
 * @author JuanAlbeticoHF
 * @version 1.0.0
 * @since 0.7.0
 */
public record AdminAgregarLineaPedidoRequestDTO(
