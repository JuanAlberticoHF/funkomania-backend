...
Actualmente, Funkomania Backend `0.4.0-RELEASE-1` incluye las siguientes funcionalidades:
...
1. Descargar el proyecto abriendo un terminal y clonar el repositorio usando Git en un directorio:
   ```bash
   git clone https://github.com/JuanAlberticoHF/funkomania-backend.git --branch 0.4.0-RELEASE-1 develop
   ```
