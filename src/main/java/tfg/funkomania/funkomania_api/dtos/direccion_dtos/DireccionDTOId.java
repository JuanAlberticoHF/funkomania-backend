...
/**
 * <p>DTO que representa una dirección con su id en el sistema de Funkomania.</p>
 *
...
@Setter
@Builder
public class DireccionDTOId {
    @Positive(message = "El ID de la dirección no puede ser un numero negativo o cero")
    private Long id;
    ...
    @NotNull(message = "El campo 'activo' no puede ser nulo o estar vacío")
    private Boolean activo;

    public DireccionDTOId(Direccion direccion) {
