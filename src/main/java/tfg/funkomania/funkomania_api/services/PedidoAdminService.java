...
public interface PedidoAdminService {
     ...
     */
    PedidoCompletoDTOId agregarUnNuevoProductoAlPedido(AdminAgregarLineaPedidoRequestDTO datosAgregarLineaPedido);
     ...
     * @param idUsuario El ID del usuario que realizó el pedido, utilizado para verificar que el usuario tenga permiso para eliminar la línea de pedido.
     */
    void eliminarProductoEnPedido(Long idPedido, Long idUsuario);
}
